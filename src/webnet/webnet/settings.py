...
SECRET_KEY = 'django-insecure-vl@rl$2-clcjqj(%(7)#ko8d4q(y=_*gss&(i1$t&@f-wzzq^-'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['webnet.neolant.com']
...
STATIC_URL = 'static/'
STATIC_ROOT = Path(BASE_DIR).parent.joinpath("static")
